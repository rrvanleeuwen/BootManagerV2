...
**Status:** ✅ Geïmplementeerd, gemerged naar `master` via PR #73 en handmatig gevalideerd op Raspberry Pi op 2026-05-29.
...
- Pi-validatie na update naar `master` is door gebruiker uitgevoerd en akkoord bevonden op 2026-05-29.
