...
| US5.2 Automatisch loggen en intervalinstelling | Partial | Missing moments + Draft-regels bestaan; echte automatische logging op NMEA interval is beperkt. |
...
| US7.3 Waarschuwingen en meldingen | Partial | Logboek missing-moments signaal bestaat; generiek paneel ontbreekt. |
